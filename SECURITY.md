# Security Policy — ZeroInject

## 🇬🇧 English

### Reporting a Vulnerability
If you discover a security vulnerability in **ZeroInject**, please report it by emailing **mulkymalikuldhaher@email.com**.
...
Jika Anda menemukan kerentanan keamanan di **ZeroInject**, silakan laporkan melalui email **mulkymalikuldhaher@email.com**.
...
### 报告漏洞
如果您在 **ZeroInject** 中发现安全漏洞，请通过电子邮件 **mulkymalikuldhaher@email.com** 报告。
